...
public class JsonTest extends TestSubjects {
    JsonFile testFile = new JsonFile("data", "test", "testSaveJarToFile.json");
    Jar jar;
    ...
    public void testLoadJarToApp() {
        ...
        assertThrows(IOException.class, () -> new JsonFile("data", "test",".json").loadFileToJar(jar));
        assertThrows(JSONException.class, () -> new JsonFile("data", "test", "syntax.json").loadFileToJar(jar));
        assertThrows(InvalidJarException.class, () -> new JsonFile("data", "test", "team.json").loadFileToJar(jar));
        assertThrows(InvalidJarException.class, () -> new JsonFile("data", "test", "type.json").loadFileToJar(jar));
    }
